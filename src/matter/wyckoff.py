# Based onwyckoff.cpp form cctbx. The special position operators
# are chosen such that special_op * x = xwhen all elements
...
def general_position_multiplicities(i):
