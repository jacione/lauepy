...
Classes for simulating a Laue diffraction on 2D area detectors
    Reflection
    LaueSimulation
Created by Xu, Ruqing on Thursday Jan 14 18:36:04 2016
Modified by Pateras, Anastasios on Wednesday Sep 25 14:22:59 2019
"""
import os,sys, pdb
import numpy as np
import matplotlib.pyplot as plt
sys.path.append('/Users/anastasiospateras/Documents/Python/Py_lib_2.x/')
from rxlibs.xmd34 import geometry as geo
from rxlibs.xmd34 import lattice as latt
from rxlibs.xmd34 import utils
...
class Reflection(object):
    '''
    Collection of related quantities & methods of a Bragg reflection
...
#         ### modification 1
#         outfile = str('/Users/anastasiospateras/Documents/Python/LP_peaks_'+var_[20:28])
...
#         ###
        ...
        ## modification 1
        outfile = str('/Users/anastasiospateras/Documents/Python/LP_peaks_G_'+str(gamma)+'_D_'+str(delta))
        np.save(outfile,self.peaks_plot)
        ###
    ...
    def make_plots(self,axes_,**kwargs):
        ...
        # pdb.set_trace()
        ###
        # outfile = str('/Users/anastasiospateras/Documents/Python/LP_labellist_G_'+str(gamma)+'_D_'+str(delta))
        # np.save(outfile,labellist)
        # Add this line to change the data type saved inside the simulator
        xy = np.stack((xs, ys), axis=1)
        outfile = str('/Users/anastasiospateras/Documents/Python/LP_xy_G_'+str(gamma)+'_D_'+str(delta))
        np.save(outfile,xy)
        ###
