...
def IntegrateBinFiles(oPar, outputprefix, verbose=False):
    """
...
def WritePeakBinaryFile(snp, sFilename):
    headerMain = {'BlockType': 1, 'DataFormat': 1, 'NumChildren': 4, 'NameSize': 9, 'BlockName': 'PeakFile',
                  'DataSize': 0, 'ChunkNumber': 0, 'TotalChunks': 0}

    headerX = {'BlockType': 1, 'DataFormat': 1, 'NumChildren': 0, 'NameSize': 12, 'BlockName': 'PixelCoord0',
               'DataSize': 0, 'ChunkNumber': 0, 'TotalChunks': 0}
    headerY = {'BlockType': 1, 'DataFormat': 1, 'NumChildren': 0, 'NameSize': 12, 'BlockName': 'PixelCoord1',
               'DataSize': 0, 'ChunkNumber': 0, 'TotalChunks': 0}
    headerInt = {'BlockType': 1, 'DataFormat': 1, 'NumChildren': 0, 'NameSize': 10, 'BlockName': 'Intensity',
                 'DataSize': 0, 'ChunkNumber': 0, 'TotalChunks': 0}
    headerPeakID = {'BlockType': 1, 'DataFormat': 1, 'NumChildren': 0, 'NameSize': 7, 'BlockName': 'PeakID',
                    'DataSize': 0, 'ChunkNumber': 0, 'TotalChunks': 0}
    n = len(snp[0])
