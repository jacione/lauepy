...
from src.hexomap.orientation import Quaternion
from src.hexomap.orientation import Rodrigues
...
def plot_binary(rawInitial, NRot=180, NDet=2, idxRot=0,idxLayer=0):
    ...
    for idxDet in range(NDet):
        ...
        ax[0,idxDet].plt.scatter(2047-b[0],2047-b[1],s=1, color ='b.',marker = 's')
        ...
        ax[1,idxDet].plt.scatter(2047-aX,2047-aY, s=1, color ='b.',marker = 's')
